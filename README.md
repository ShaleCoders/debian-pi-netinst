...
The minimal Raspbian unattended netinstaller for Raspberry Pi Model 1B, 1B+ and 2B, 3B, Zero & Zero W 
...
You can customize the installed packages by adding a small configuration file to your SD card before booting up.
...
## Features
 ...
 - always installs the latest version of Raspbian & Kernel/Firmware
...
## Requirements
 - a Raspberry Pi Model 1B, Model 1B+, Model 2B, Model 3B, Model Zero or Model ZeroW
 - SD card of at least 640MB or at least 128MB for USB root install (without customization)
 - working Ethernet with Internet connectivity (WI-FI on selected models)
...
Go to [our latest release page](https://github.com/twinusers/debian-pi-netinst/releases/latest) and download the .zip file.
...
Go to [our latest release page](https://github.com/twinusers/debian-pi-netinst/releases/latest) and download the .img.bz2 file.

Extract the .img file from the archive with `bunzip2 debian-pi-netinst-<latest-version-number>.img.bz2`.  
...
To flash your SD card on Mac:
    ...
    sudo dd bs=1m if=/path/to/debian-pi-netinst-<latest-version-number>.img of=/dev/rdiskX
...
Go to [our latest release page](https://github.com/twinusers/debian-pi-netinst-netinst/releases/latest) and download the .img.xz file.

To flash your SD card on Linux:

    xzcat /path/to/debian-pi-netinst-<latest-version-number>.img.xz > /dev/sdX
